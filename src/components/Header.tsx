...
<div className="absolute right-5 top-10 z-50 max-md:block md:hidden cursor-pointer" onClick={isMenuOpen}>
  {isOpen ? (
...
<div className={`flex justify-between gap-5  max-md:bg-[#11151d] max-md:absolute max-md:left-0 max-md:top-0 max-md:right-0 max-md:py-20 max-md:bg-muted max-md:z-40 max-md:flex-col transform transition-all duration-500 ease-in-out ${isOpen ? "max-md:max-w-full max-md:translate-x-0 max-md:opacity-100 max-md:visible" : "max-md:max-w-0 max-md:translate-x-full max-md:opacity-0 max-md:invisible"}`}>
