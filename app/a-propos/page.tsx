  ...
  return (
    <div className="min-h-screen py-6 sm:py-8 md:py-12 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            >
              {mainTechnologies.map((tech, index) => (
                <Badge 
                  key={index} 
                  className={cn("px-2 py-0.5 sm:px-3 sm:py-1 text-xs sm:text-sm text-white", tech.color)}
                >
                  {tech.name}
                </Badge>
              ))}
        ...
        >
          <motion.p variants={itemVariants} className="text-sm sm:text-base md:text-lg leading-relaxed">
        ...
        >
          <motion.div variants={itemVariants} className="flex items-center gap-3 mb-4 md:mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Parcours Professionnel</h2>
          </motion.div>
          
          <motion.p variants={itemVariants} className="text-sm sm:text-base md:text-lg mb-6 md:mb-8 text-muted-foreground">
              ...
              <Card className="border-l-4 border-l-blue-600 hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-3 sm:px-4">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    <div>
                      <CardTitle className="text-lg sm:text-xl font-bold">Samina</CardTitle>
                    ...
                    <Badge className="bg-green-600/80 text-white text-xs">Actuel</Badge>
                  </div>
                </CardHeader>
                <CardContent className="px-3 sm:px-4 py-2 sm:py-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    <Badge variant="outline" className="bg-card/60 text-xs">Angular</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">ASP.NET</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">MySQL</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">Azure</Badge>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={timelineItemVariants} className="relative">
              <Card className="border-l-4 border-l-purple-600 hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-3 sm:px-4">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    <div>
                      <CardTitle className="text-lg sm:text-xl font-bold">MKParis Concept</CardTitle>
                      <CardDescription className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1 text-xs sm:text-sm">
                        <Building size={12} className="text-muted-foreground" />
                ...
                <CardContent className="px-3 sm:px-4 py-2 sm:py-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    <Badge variant="outline" className="bg-card/60 text-xs">React Native</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">TypeScript</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">Firebase</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">MySQL</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">Azure</Badge>
                  </div>
                </CardContent>
            ...
            <motion.div variants={timelineItemVariants} className="relative">
              <Card className="border-l-4 border-l-amber-600 hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-3 sm:px-4">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    <div>
                      <CardTitle className="text-lg sm:text-xl font-bold">Projets Freelance</CardTitle>
                      <CardDescription className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1 text-xs sm:text-sm">
                ...
                <CardContent className="px-3 sm:px-4 py-2 sm:py-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    <Badge variant="outline" className="bg-card/60 text-xs">Next.js</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">TypeScript</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">React Native</Badge>
                    <Badge variant="outline" className="bg-card/60 text-xs">Firebase</Badge>
                  </div>
            ...
            <motion.div variants={timelineItemVariants}>
              <Card className="border-l-4 border-l-green-600 hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-3 sm:px-4">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    <div>
                      <CardTitle className="text-lg sm:text-xl font-bold">Licence en génie logiciel</CardTitle>
                      <CardDescription className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1 text-xs sm:text-sm">
                        <Building size={12} className="text-muted-foreground" />
            ...
            <motion.div variants={timelineItemVariants}>
              <Card className="border-l-4 border-l-blue-600 hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-3 sm:px-4">
                  <div className="flex flex-wrap justify-between items-start gap-2">
                    <div>
                      <CardTitle className="text-lg sm:text-xl font-bold">Certification Azure Administrator (AZ-104)</CardTitle>
                      <CardDescription className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1 text-xs sm:text-sm">
                        <Award size={12} className="text-muted-foreground" />
                        <span>Microsoft</span>
                      </CardDescription>
                    </div>
                    <Badge className="bg-blue-600/80 text-white text-xs">Certifié</Badge>
                  </div>
                </CardHeader>
                <CardContent className="px-3 sm:px-4 py-2 sm:py-3">
                  <p className="text-xs sm:text-sm text-muted-foreground">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4">Ma philosophie</h2>
