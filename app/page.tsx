      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            >
              {mainTechnologies.map((tech, index) => (
                <Badge 
                  key={index} 
                  className={cn("px-2 py-1 sm:px-3 text-xs sm:text-sm text-white", tech.color)}
                >
                  {tech.name}
                </Badge>
              ))}
            ...
            >
              <Link href="/mon-cv.pdf" target="_blank" download className="w-full sm:w-auto">
                <Button
                  ...
                  size="lg"
                >
                  <Download className="mr-2 h-4 w-4 sm:h-5 sm:w-5" /> Télécharger Mon CV
                </Button>
              </Link>
              ...
              <Link href="/a-propos" className="w-full sm:w-auto">
                <Button
                  ...
                  size="lg"
                >
                  <ArrowRight className="mr-2 h-4 w-4 sm:h-5 sm:w-5" /> En savoir plus
                </Button>
              </Link>
            </motion.div>
          </div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            <Link href="https://github.com/AlmamyHaidara" target="_blank" className="w-full">
              <Button
                variant="outline"
            ...
            <Link href="https://www.linkedin.com/in/almamy-ha%C3%AFdara-612028210/" target="_blank" className="w-full">
              <Button
                variant="outline"
                className="w-full px-4 py-4 sm:px-5 sm:py-5 text-sm sm:text-base border-border/50 hover:border-primary hover:bg-primary/5"
                size="lg"
            ...
            <Link href="mailto:almamyh27@gmail.com" className="w-full">
              <Button
                ...
                size="lg"
              >
                <ExternalLink className="mr-2 h-4 w-4 sm:h-5 sm:w-5" /> almamyh27@gmail.com
              </Button>
            </Link>
          </motion.div>
        </motion.section>
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-base sm:text-lg mb-6 md:mb-8 text-muted-foreground max-w-3xl">
          ...
          >
            <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-2/3">
              <Card className="p-3 sm:p-4 h-full w-full hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-2 sm:px-4">
                  <CardTitle className="text-lg sm:text-xl font-semibold">Travail</CardTitle>
                </CardHeader>
                      ...
                      >
                        ...
                        <div className="overflow-hidden">
                          <h3 className="font-semibold text-base sm:text-lg flex flex-wrap items-center gap-2">
                            {work.title}
                            {work.freelance && (
                              <Badge className="bg-primary text-white text-xs mt-1 sm:mt-0">Freelance</Badge>
                            )}
                          </h3>
                          <p className="text-xs sm:text-sm text-muted-foreground line-clamp-2">{work.role}</p>
            ...
            <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-1/3">
              <Card className="p-3 sm:p-4 h-full w-full hover:shadow-md transition-shadow">
                <CardHeader className="pb-1 sm:pb-2 px-2 sm:px-4">
                  <CardTitle className="text-lg sm:text-xl font-semibold">Contactez-moi</CardTitle>
                </CardHeader>
                <CardContent className="px-2 sm:px-4">
                  <div className="flex flex-col gap-3 sm:gap-4">
                    {CONTACTME.map((contact, index) => (
                      ...
                      >
                        ...
                        <div className="overflow-hidden">
                          ...
                          <p className="text-xs sm:text-sm text-muted-foreground truncate">{contact.description}</p>
                        </div>
                      </motion.a>
                    ))}
                  </div>
        ...
        >
          <motion.div variants={itemVariants} className="flex items-center gap-3 mb-4 md:mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Comment puis-je vous aider?</h2>
          </motion.div>
        ...
        >
          ...
          >
            <motion.div variants={itemVariants} className="bg-card/30 p-4 sm:p-6 rounded-xl border border-border/50">
          ...
          >
            <Link href="/a-propos" className="w-full sm:w-auto">
              <Button
                ...
                size="lg"
              >
                Découvrir mon parcours <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </Button>
            </Link>
          </motion.div>
        </motion.section>
